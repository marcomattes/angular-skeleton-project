...
describe(`EarthquakeServiceTests`, () => {
  ...
  it('_mapEarthquakes should map earthquake data back to Earthquake objects', () => {
  ...
  it('_mapEarthquakes should map multiple earthquake data back to Earthquake objects', () => {
  ...
  it('_mapEarthquakes should map earthquake data back to Earthquake objects and limit number returned', () => {
    let earthquakeFeatures: EarthquakeFeature[] = [
